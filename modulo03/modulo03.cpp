...
GLuint loadTexture(const std::string& path)
{
    ...
    stbi_set_flip_vertically_on_load(true); // OpenGL espera Y invertido
...
std::string loadMTL(const std::string& mtlPath)
{
    ...
    while (std::getline(file, line))
    {
        ...
        if (keyword == "map_Kd") // difuse map = textura principal
        {
            ss >> textureName;
            break;
        }
    ...
    while (std::getline(arqEntrada, line))
    {
        ...
        else if (word == "f")
        {
            while (ssline >> word)
            {
                ...
                // UVs — guarda (0,0) se não houver texCoords
...
int setupGeometry()
{
    ...
    // FACE DIREITA (x = +0.5) — AMARELO
     0.5f, -0.5f,  0.5f,  1.0f, 0.9f, 0.1f,  0.0f, 0.0f,
     0.5f, -0.5f, -0.5f,  1.0f, 0.9f, 0.1f,  1.0f, 0.0f,
     0.5f,  0.5f, -0.5f,  1.0f, 0.9f, 0.1f,  1.0f, 1.0f,

     0.5f,  0.5f, -0.5f,  1.0f, 0.9f, 0.1f,  1.0f, 1.0f,
     0.5f,  0.5f,  0.5f,  1.0f, 0.9f, 0.1f,  0.0f, 1.0f,
     0.5f, -0.5f,  0.5f,  1.0f, 0.9f, 0.1f,  0.0f, 0.0f,

    // FACE SUPERIOR (y = +0.5) — CIANO
    -0.5f,  0.5f,  0.5f,  0.1f, 0.9f, 0.9f,  0.0f, 0.0f,
     0.5f,  0.5f,  0.5f,  0.1f, 0.9f, 0.9f,  1.0f, 0.0f,
     0.5f,  0.5f, -0.5f,  0.1f, 0.9f, 0.9f,  1.0f, 1.0f,

     0.5f,  0.5f, -0.5f,  0.1f, 0.9f, 0.9f,  1.0f, 1.0f,
    -0.5f,  0.5f, -0.5f,  0.1f, 0.9f, 0.9f,  0.0f, 1.0f,
    -0.5f,  0.5f,  0.5f,  0.1f, 0.9f, 0.9f,  0.0f, 0.0f,

    // FACE INFERIOR (y = -0.5) — MAGENTA
    -0.5f, -0.5f, -0.5f,  0.9f, 0.2f, 0.9f,  0.0f, 0.0f,
     0.5f, -0.5f, -0.5f,  0.9f, 0.2f, 0.9f,  1.0f, 0.0f,
     0.5f, -0.5f,  0.5f,  0.9f, 0.2f, 0.9f,  1.0f, 1.0f,

     0.5f, -0.5f,  0.5f,  0.9f, 0.2f, 0.9f,  1.0f, 1.0f,
    -0.5f, -0.5f,  0.5f,  0.9f, 0.2f, 0.9f,  0.0f, 1.0f,
    -0.5f, -0.5f, -0.5f,  0.9f, 0.2f, 0.9f,  0.0f, 0.0f,
};
